...
class AIMoves():
    #Class that make the object move in a partially inteligent way the screen
    def __init__(self,rect,width,height,player_rect):
        self.rect = rect
        self.moving_speed = 5
        ...
        self.input_list = ['player','player','player','player','up','left','right']
